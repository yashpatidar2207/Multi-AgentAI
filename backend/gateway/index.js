...
app.use("/api/agents",protectService,proxyWithHeader(process.env.AGENTS_SERVICE))
app.use("/api/billing",protectService,proxyWithHeader(process.env.BILLING_SERVICE))
app.get('/',(req,res)=>{
